...
public class ShanghuguanliActivity extends BaseHttpRecyclerActivity<Piclb, PiclbView, PiclibAdapter> {
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, ShanghuguanliActivity.class);
    }
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (title){
            case "商户认证":
                Intent intent = ShanghuReisterActivity.createIntent(ShanghuguanliActivity.this);

                startActivity(intent);
                break;
            case "发布收购":
                Intent intent2 = ShanghuBuyActivity.createIntent(ShanghuguanliActivity.this);
                startActivity(intent2);
                break;
            case "收购信息管理":
                Intent intent3 = ShouGouDingdanActivity.createIntent(ShanghuguanliActivity.this);
                startActivity(intent3);
                break;
            case "服务订单管理":
                Intent intent4 = JieshouDingDanActivity.createIntent(ShanghuguanliActivity.this);
                startActivity(intent4);
                break;
            default:
                break;
        }
//        Intent intent = DingdanDetailActivity.createIntent(ShanghuguanliActivity.this);
//        startActivity(intent);
        //把返回数据存入Intent
        ...
        Subscription subscription = HKEapiManager.getInstances().demoApi.index(URLConfig.CHECKSMS_URL)
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String s) {
                        s = "[{\"TITLE\":\"商户认证\",\"ORDER_ID\":\"13900034567\",\"PATH\":\"http://47.92.55.233:8080/hdrra/uploadFiles/uploadImgs/20190116/82b68c5920a24f8790a3922c0b496502.png\"},{\"TITLE\":\"发布收购\",\"ORDER_ID\":\"13900034567\",\"PATH\":\"http://47.92.55.233:8080/hdrra/uploadFiles/uploadImgs/20190116/82b68c5920a24f8790a3922c0b496502.png\"},{\"TITLE\":\"收购信息管理\",\"ORDER_ID\":\"13900034567\",\"PATH\":\"http://47.92.55.233:8080/hdrra/uploadFiles/uploadImgs/20190116/82b68c5920a24f8790a3922c0b496502.png\"},{\"TITLE\":\"服务订单管理\",\"ORDER_ID\":\"13900034567\",\"PATH\":\"http://47.92.55.233:8080/hdrra/uploadFiles/uploadImgs/20190116/82b68c5920a24f8790a3922c0b496502.png\"}]";
                        try {

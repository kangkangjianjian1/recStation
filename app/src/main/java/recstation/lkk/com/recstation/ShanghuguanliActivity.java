    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        switch (title){
            case "商户认证":
                ...
                break;
            case "发布收购订单":
                Intent intent2 = DingdanDetailActivity.createIntent(ShanghuguanliActivity.this);
                startActivity(intent2);
                break;
            case "收购订单管理":
                Intent intent3 = DingdanDetailActivity.createIntent(ShanghuguanliActivity.this);
        ...
        Subscription subscription = HKEapiManager.getInstances().demoApi.index(URLConfig.CHECKSMS_URL)
                ...
                .subscribe(new Action1<String>() {
                    ...
                    public void call(String s) {
                        s = "[{\"TITLE\":\"商户认证\",\"ORDER_ID\":\"13900034567\",\"PATH\":\"http://47.92.55.233:8080/hdrra/uploadFiles/uploadImgs/20190116/82b68c5920a24f8790a3922c0b496502.png\"},{\"TITLE\":\"发布收购订单\",\"ORDER_ID\":\"13900034567\",\"PATH\":\"http://47.92.55.233:8080/hdrra/uploadFiles/uploadImgs/20190116/82b68c5920a24f8790a3922c0b496502.png\"},{\"TITLE\":\"收购订单管理\",\"ORDER_ID\":\"13900034567\",\"PATH\":\"http://47.92.55.233:8080/hdrra/uploadFiles/uploadImgs/20190116/82b68c5920a24f8790a3922c0b496502.png\"}]";
                        try {

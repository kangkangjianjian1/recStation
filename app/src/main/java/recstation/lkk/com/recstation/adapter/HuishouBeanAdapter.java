 ...
 * @author lkk
 */
public class HuishouBeanAdapter extends BaseAdapter<HuishouBean, HuishouBeanView> {
	//	private static final String TAG = "UserAdapter";

	public HuishouBeanAdapter(Activity context) {
		super(context);
	}

	@Override
	public HuishouBeanView createView(int position, ViewGroup parent) {
		return new HuishouBeanView(context, parent);
	}

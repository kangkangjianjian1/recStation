...
public class RecpersonView extends BaseView<RecPerson> {
	...
	public void bindView(RecPerson data_){
		...
		tv_recperson_name.setText(StringUtil.getTrimedString(data.getNAME()));
		tv_recperson_price.setText(data.getPRICE()+"元/公斤");
		tv_recperson_phone.setText(StringUtil.getNoBlankString(data.getPHONE()));
		tv_recperson_content.setText(StringUtil.getNoBlankString(data.getCONTENT()));
	}

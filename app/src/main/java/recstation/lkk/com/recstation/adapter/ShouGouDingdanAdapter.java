 ...
 * @author lkk
 */
public class ShouGouDingdanAdapter extends BaseAdapter<Dingdanbean, ShougouDingdanView> {
	//	private static final String TAG = "DingdanAdapter";

	public ShouGouDingdanAdapter(Activity context) {
		super(context);
	}

	@Override
	public ShougouDingdanView createView(int position, ViewGroup parent) {
		return new ShougouDingdanView(context, parent);
	}
